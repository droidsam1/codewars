...
public class SudokuExamples {
    ...
    public static class EASY_PUZZLES {
        ...
        public static SudokuExample EASY_EXAMPLE_1 = new SudokuExample(EASY_EXAMPLE_1_SOLUTION, EASY_EXAMPLE_1_PUZZLE);
        public static SudokuExample EASY_EXAMPLE_2 = new SudokuExample(EASY_EXAMPLE_2_SOLUTION, EASY_EXAMPLE_2_PUZZLE);
